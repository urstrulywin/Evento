...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      city === "all" ? "Browse all events" : `Browse events in ${titleCity}`,
  };
}
...
export default async function EventsPage({
  ...
  return (
    <main className="container mx-auto flex flex-col items-center pt-10">
      <H1>{city === "all" ? "All Events" : `Events in ${title}`}</H1>
